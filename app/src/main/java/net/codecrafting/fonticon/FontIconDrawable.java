...
public class FontIconDrawable extends Drawable {
     ...
     * @param iconFont    The iconFont.
     */
    public FontIconDrawable(Context context, String icon, String iconFont)
    {
    ...
    {
        try {
            paint.setTypeface(TypefaceHandler.get(context, "fonts/"+ iconFont));
        } catch(Exception e) {
